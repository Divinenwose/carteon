    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#252C46] via-[#3B4266] to-[#1E2338]">
            <div className="bg-white w-full max-w-[560px] mx-4 sm:mx-6 p-4 sm:p-6 rounded-xl shadow-xl border border-gray-200">
                <h2 className="font-Inter font-bold text-[20px] sm:text-[22px] md:text-[25.5px] leading-[30px] sm:leading-[33px] md:leading-[36px] text-[#0F172A] align-middle">Welcome back</h2>
                <p className="font-Inter font-normal text-[12px] sm:text-[13px] md:text-[13.6px] leading-[20px] sm:leading-[22px] md:leading-[24px] text-[#475569] align-middle mt-3">Log in to continue to your dashboard.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                    ...
                    <div>
                        <label htmlFor="password" className="font-Inter font-medium text-[14px] sm:text-[15px] md:text-[16px] leading-[18px] sm:leading-[19px] md:leading-[20px] text-[#1A1A1A] align-middle block mb-2">Password</label>
                        <input
                            type="password"
                            name="password"
                ...
                <div className="text-center mt-4">
                    <p className="font-outfit font-normal text-[16px] sm:text-[17px] md:text-[18px] leading-[100%] text-[#505256] text-center">New to Carteon? <a href="/signup" className="font-outfit underline font-normal text-[16px] sm:text-[17px] md:text-[18px] leading-[100%] text-[#252C46]">Create an account</a></p>
                </div>
            </div>
        </div>
    );
